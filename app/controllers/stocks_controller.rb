class StocksController < ApplicationController
  ...
  def correct_user
    ...
    redirect_to stocks_path,notice: "Not authorized to edit this stock-sucker!" if @stock.nil?
  end
  private
    ...
    def stock_params
      params.require(:stock).permit(:productId, :productName, :price, :product_type, :user_id)
    end
end
